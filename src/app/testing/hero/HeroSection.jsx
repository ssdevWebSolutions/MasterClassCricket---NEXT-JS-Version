      ...
      <div className="heroInner">
        ...
        <div className="heroLeft">
          ...
          <p className="heroDescription">
            Join our upcoming professional cricket camps designed for every
            player who wants to sharpen their skills, boost performance, and
        ...
        <div className="heroRight">
          <div className="heroImageCard">
            <div className="heroImageInner">
              <img src="/elite-performance.png" alt="Cricket gear on field" />
            </div>
