...
const SocialMediaSection = () => {
  ...
  const handleFollowUs = () => {
    window.open(
      "https://www.instagram.com/masterclasscricket",
      "_blank",
      "noopener,noreferrer",
    );
  };
    ...
    <section className={styles.igReelsSection}>
      ...
      <div className={`${styles.igDecorativeBat} ${styles.igBatTopLeft}`}>
        <svg
          ...
          className={styles.igCricketBatSvg}
        >
          <defs>
          ...
          {/* Bat shoulder */}
          <path
            d="M43,110 C40,115 30,120 30,125 L30,135 L70,135 L70,125 C70,120 60,115 57,110 Z"
            fill="#a16207"
          />

          {/* Bat blade */}
          <path
            d="M30,135 L30,350 C30,380 50,390 50,390 C50,390 70,380 70,350 L70,135 Z"
            fill="url(#bat-gradient)"
          />

          {/* Bat edge */}
          <path
            d="M30,135 L30,350 C30,380 50,390 50,390"
            fill="none"
            stroke="#713f12"
            strokeWidth="2"
          />
          <path
            d="M70,135 L70,350 C70,380 50,390 50,390"
            fill="none"
            stroke="#713f12"
            strokeWidth="2"
          />
      ...
      <div className={`${styles.igDecorativeBall} ${styles.igBallBottomRight}`}>
        <svg
          viewBox="0 0 100 100"
          xmlns="http://www.w3.org/2000/svg"
          className={styles.igCricketBallSvg}
        >
          <defs>
            <radialGradient
              id="ball-gradient"
        ...
        {socialCards.map((card) => (
          <div key={card.id} className={styles.igSocialCard}>
            <div className={styles.igCardHeader}>
              ...
              <button
                className={styles.igViewProfileBtn}
            ...
            <div
              ...
              onClick={(e) =>
                toggleVideo(card.videoId, card.thumbnailId, e.currentTarget)
              }
            >
              <img
                id={card.thumbnailId}
            ...
            <div className={styles.igCardDetails}>
              ...
              <p className={styles.igViewMore}>View more on Instagram</p>
            </div>
          </div>
        ))}
      </div>
