...
const PartnersSection = () => {
  ...
  return (
    <>
      <section
        className={styles.partnershipEliteSection}
        id="partners"
        ref={sectionRef}
      >
        ...
        <div className={styles.partnershipHeadingContainer}>
          ...
          <div className={styles.partnershipTitleBackground}>
            Elite Sponsorships
          </div>
          <h2 className={styles.partnershipTitle}>
            Our{" "}
            <span className={styles.partnershipTitleHighlight}>Trusted</span>{" "}
            Cricket Partners
          </h2>
          <p className={styles.partnershipDescription}>
            At <strong>Masterclass Cricket</strong> Academy, we believe in
            building strong partnerships with local businesses and organisations
            that share our vision for growth, excellence, and community impact.
            We collaborate with industry-leading brands that add value to our
            students&apos; development, providing them with access to top-tier
            training equipment, world-class facilities, and unique
            opportunities. We&apos;re always looking to form meaningful
            relationships with businesses that align with our values. If
            you&apos;re a brand that wants to partner with Masterclass Cricket
            and be part of our journey, we&apos;d love to hear from you. Get in
            ...
            sponsor: [
              {
                ...
                description:
                  "Gold partner providing premium cricket equipment.",
              },
              {
                "@type": "Organization",
                name: "Platinum Cricket Sponsor",
                description:
                  "Elite sponsor supporting cricket training and facilities.",
              },
            ],
          }),
        }}
