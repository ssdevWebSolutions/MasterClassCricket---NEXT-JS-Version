        ...
        <div className={styles.coachesContainer}>
          <div className={styles.coachesHeadingWrapper}>
            <h2 className={styles.coachesHeading}>
              MEET THE COACHES AND MENTOR
            </h2>
            <div className={styles.coachesHeadingUnderline}></div>
            <p className={styles.coachesSubheading}>
              Meet the masterminds behind our cricket excellence
            </p>
          </div>
                  ...
                  >
                    <div className={styles.coachCardFront}>
                      <div className={styles.coachImageContainer}>
                        ...
                        <div className={styles.coachCredentials}>
                          <span className={styles.coachExperience}>
                            {coach.experience}
                          </span>
                        </div>
                      </div>
                    ...
                    <div className={styles.coachCardBack}>
                      <div className={styles.coachDetails}>
                        ...
                        >
                          <p
                            className={`${styles.coachBio} ${coach.name === "Patrick Littlemore" ? styles.coachBioMentor : ""}`}
                          >
                            {coach.bio}
                          </p>
                        </div>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            reviewBody:
              "We've trained with Masterclass Cricket Academy for 10 years, and the professional coaching is unmatched. Thanks to expert batting, bowling, and fielding training, my son progressed from borough cricket to the County Winter Squad.",
          }),
        }}
      />
    </>
